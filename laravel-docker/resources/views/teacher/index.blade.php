...
<head>
	<meta charset="UTF-8">
    <title>Trang chủ giảng viên</title>
        ...
        <div style="padding-top:30px">
            <div class="row">
                ...
                <div class="col-md-3" style="float: right">  
                    @include('teacher.layout.information_private')
                    @include('teacher.layout.operation_system')
                         
                </div>
            </div>
            @include('teacher.layout.update_information_private')
        </div>
    </div>
    <br><br>
